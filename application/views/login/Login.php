    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="<?= base_url(); ?>assets/gambar/Bullwhip_effect.png" alt="Chania">
        </div>

        <div class="item">
          <img src="<?= base_url(); ?>assets/gambar/business_framework_bullwhip_effect_in_supply_chains_powerpoint_presentation_2_1.jpg" alt="Chania">
        </div>

        <div class="item">
          <img src="<?= base_url(); ?>assets/gambar/img12.jpg" alt="Flower">
        </div>

        <div class="item">
          <img src="<?= base_url(); ?>assets/gambar/pZjJsM2.jpg" alt="Flower">
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-sm-offset-3 form-box">
        ...
        <div class="form-bottom">
          <form role="form" action="<?php echo base_url('index.php/login/process'); ?>" method="post" class="login-form">
